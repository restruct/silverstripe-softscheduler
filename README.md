...
the same for editors as for visitors; they can still open a scheduled page by its URL. Inside the CMS
...
available. `master` is the only maintained line: it supports every Silverstripe version this module
